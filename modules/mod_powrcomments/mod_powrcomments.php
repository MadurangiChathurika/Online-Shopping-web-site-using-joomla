<?php
/**
* Joomla! POWr Comments
*
* @version 2.0
* @author POWr.io
* @package POWr Comments
* @subpackage POWr
      ...
      public function add_powr_js(){
        ...
        if($POWR_JS_ADDED){
          return;
		    ...
		    $js_url = JURI::base()."modules/mod_powrcomments/powr_joomla.js";
        $js = "(function(d){
...
//Create Helper
new PowrHelper();
echo "<div class='powr-comments' label='joomla_$module->id'></div>";
?>